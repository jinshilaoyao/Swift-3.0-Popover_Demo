...
class ViewController: UIViewController {
  ...
  fileprivate var texts = ["Edit", "Delete", "Report","UIButton","UILabel"]
  ...
  @IBAction func tappedRightBarButton(_ sender: UIBarButtonItem) {
    ...
    let aView = UIView(frame: CGRect(x: 0, y: 0, width: self.view.frame.width - 180, height: 180))
  ...
  @IBAction func tappedRightButtomButton(_ sender: UIButton) {
    let tableView = UITableView(frame: CGRect(x: 0, y: 0, width: self.view.frame.width - 100, height: 200))
